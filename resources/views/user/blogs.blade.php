...
<section class="ca-hero">
    <div class="container">
        ...
        <p class="sub">Guides on visa sponsorship, pay and entry requirements for work in {{ $coverage->shortList() }} &mdash; written from official sources, and clear about which routes are closed.</p>
