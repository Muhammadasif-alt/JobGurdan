...
@section('meta_description', 'The Sajjad Digital Services Terms of Service: account registration, acceptable use, employer and job seeker responsibilities, and limitation of liability.')
@section('content')
...
<section class="legal-wrap">
    <div class="container">
        <div class="legal-card">
            ...
            <p>Welcome to Sajjad Digital Services. These Terms of Service ("Terms") govern your access to and use of our website, mobile applications, and related services (the "Service"). By accessing or using the Service, you agree to be bound by these Terms. If you do not agree, please do not use the Service.</p>
            ...
            <p>You retain ownership of your User Content. By submitting User Content, you grant Sajjad Digital Services a worldwide, non-exclusive, royalty-free, sublicensable license to host, store, reproduce, display, and distribute that content solely for the purpose of operating and improving the Service.</p>
            ...
            <p>The Service, including its design, text, graphics, logos, software, and underlying technology, is owned by Sajjad Digital Services or its licensors and is protected by copyright, trademark, and other intellectual property laws. You may not copy, modify, distribute, reverse-engineer, or create derivative works of any part of the Service without our prior written consent.</p>
            <p>"Sajjad Digital Services" and our logo are trademarks of our company. You may not use them without our prior written permission.</p>
            ...
            <p>The Service is provided <strong>"as is"</strong> and <strong>"as available"</strong> without warranties of any kind, either express or implied. To the maximum extent permitted by law, Sajjad Digital Services disclaims all warranties, including merchantability, fitness for a particular purpose, non-infringement, and accuracy of information.</p>
            ...
            <p>To the maximum extent permitted by law, in no event shall Sajjad Digital Services, its officers, directors, employees, or affiliates be liable for any indirect, incidental, special, consequential, or punitive damages, including lost profits, lost data, or business interruption, arising out of or related to your use of the Service.</p>
