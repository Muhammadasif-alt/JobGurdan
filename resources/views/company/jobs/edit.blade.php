...
<div class="cf-page" style="padding: 24px; max-width: 1080px;">
    <div class="cj-form-head" style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px;margin-bottom:22px;">
        <div>
            <h1 style="font-size:26px;font-weight:800;margin:0;letter-spacing:-.4px;background:linear-gradient(90deg,#1b3a6b,#4a90d9);-webkit-background-clip:text;background-clip:text;-webkit-text-fill-color:transparent;color:transparent;">
                Edit Job
            </h1>
            <div class="breadcrumbs" style="font-size:14px;color:#6b7280;margin-top:4px;">
                <a href="{{ route('company.dashboard') }}" style="color:#1b3a6b;text-decoration:none;font-weight:600;">Dashboard</a>
                <span class="mx-1">/</span>
                <a href="{{ route('company.jobs.index') }}" style="color:#1b3a6b;text-decoration:none;font-weight:600;">Jobs</a>
                <span class="mx-1">/</span>
