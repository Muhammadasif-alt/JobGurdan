...
it('ships the footer background image', function () {
    ...
    get('/')->assertOk()->assertSee('user/images/footer-photo-bg.jpg', false);
});
...
it('gives the dark theme the same photograph under a darker overlay', function () {
    ...
    expect($html)->toContain('html.dark-mode #footer {')
        ...
        ->and(substr_count($html, 'footer-photo-bg.jpg'))->toBeGreaterThanOrEqual(2);
});
